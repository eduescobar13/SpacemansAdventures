...
public class node { // Clase para la creación de los nodos que usaremos en la lista.
...
//-----> DECLARACIÓN DE LOS ATRIBUTOS DE LA CLASE.
	...
	private node father;  // Variable father que nos indica el nodo previo para llegar al actual.
	private boolean obstacle; // Variable para detectar un obstacle.
	  
//-----> DECLARACIÓN DE LOS MÉTODOS DE LA CLASE.
	
	public node() { // Constructor por defecto.
	...
	public node(int x, int y, boolean s) { // Constructor.
	...
	public boolean equal(node a) { // Método para la sobrecarga del operador ==.
